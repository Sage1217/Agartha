...
int choice;
  do
  {
   ...
   cout << "Mary: The survivalist's trusty bow named after the mother of christ. The bow does twenty base damage but if the survivalist gets a head shot, the target dies instantly as long as the target is not a giant enemy. Head shots have a five percent chance to occur in normal battle." << endl;
              ...
              cout << "Traps: The survivalist can set up a trap right before he hides that give him an advantage in battle. However, setting up traps also has the chance of the survivalist being found right away by the enemy depending on long it takes to set up the trap. The two traps he knows how to set up are the bear and pitfall traps. " << endl;
              cout << "Black Hooded Leather Outfit: The survivalist wears a lightweight leather outfit that gives him a stealth bonus." << endl;
    }
    else if (choice == 3)
    {
      cout << "Game Start!" << endl;
...
int choice;
  do
  {
    ...
    if (choice == 1)
    {
      cout << "Long ago before the age of man there was the age of dragons." << endl;
      cout << "When the eight dragon lords ruled Thule, humans were slaves to the Dragon Lords and lived in fear of evoking their wraith." << endl;
      cout << "Humanity had gotten into this trouble because they betrayed God in the garden of eden and gave into the devil temptations." << endl;
      cout << "Satan tempted the humans by promising them if they follow him instead of God, they will live safe and secure lives underneath Satan's dragon lord who possessed powers greater than God." << endl;
      cout << "He also told the humans that God was lying about loving and protecting them and just wanted them to be slaves who will work for him forever." << endl;
      cout << "God then came and casted the devil out of his Garden and told the humans not listen to such lies about him but the devil had already sewn doubt into the humans hearts and they told God that they had abandoned him." << endl;
      cout << "God saddened by humans decision told them that they are making a mistake and that he will give those realize their mistake back into the Garden." << endl;
      cout << "After a while of being tormented by the dragon lords, a group of humans in secret prayed to God and asked for his forgiveness." << endl;
      cout << "God then sent his Angels and freed the humans from their enslavement." << endl;
      cout << "Satan infuriated with dragon lord's performance and humiliating defeat destroyed the dragon lords souls and combined the fragments of their soul into one mega soul." << endl;
      cout << "He then entombed this soul in the core layer of the planet and this soul fueled by the hatred of the dragon lords birthed a being known as the dragon knight." << endl;
      cout << "The Dragon Knight formed into a dragon with a female humanoid body gets up out of her tomb and hears the voices of her ancestors speaking to her." << endl;
      cout << "They tell her that she is last dragon and she must kill all of humans in Agartha to avenge her fallen kin; then they cover her body with armor made from the dragon bones and give her a great sword with runes etched into blades." << endl;
      cout << "Afterwards the voices tell her that with these tools, she can harness the lost powers of the dragon lords and complete her mission. " << endl;
      cout << "The Dragon Knight then sets off to avenge her fallen kin." << endl;
      cout << "Use the power of the dragon lords and your great sword to well with character!" << endl;
    }
    else if (choice == 2)
    {
      cout << "" << endl;
...
int choice;
  do
  {
    try
    {
      ...
      {
        throw "\nInvalid Choice! Choose something between 1-8.\n";
      }
    }
    catch (char const *error)
    {
...
void display_main_menu()
{
  ...
  cout << "|                                           |" << std::endl;
  cout << "|                 Agartha                   |" << std::endl;
  cout << "|                                           |" << std::endl;
  cout << "|_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _|" << std::endl;
